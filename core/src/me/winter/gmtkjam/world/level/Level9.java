...
public class Level9 implements Level {
    ...
    public void load(WaterWorld world) {
        ...
        world.addEntity(new Duck(world, new Vector2(10.0f * 16.0f, 2.0f * 16.0f), new Vector2(6f * 16f, 2f * 16.0f)));
        world.addEntity(new Duck(world, new Vector2(6.0f * 16.0f, 7.0f * 16.0f), new Vector2(10f * 16f, 7f * 16.0f)));

        world.addEntity(new Rock(world, new Vector2(8.0f * 16.0f, 4.5f * 16.0f), 0.0f));
        world.addEntity(new Log(world, new Vector2(8.0f * 16.0f, 3.5f * 16.0f), 0.0f, new Vector2()));
        world.addEntity(new Log(world, new Vector2(8.0f * 16.0f, 5.5f * 16.0f), 0.0f, new Vector2()));
